...
- **Recorrência do cartão abate as parcelas**: se você criar um **lançamento recorrente com a categoria = nome do cartão** (o pagamento fixo da fatura), o valor dele naquele mês é **descontado das parcelas** — evitando contar em dobro. Se cobrir tudo, a previsão de parcelas do mês desaparece. (Apenas **recorrências** abatem; agendamentos avulsos com a mesma categoria **não** escondem as parcelas.)
