...
- **🔄 Reprojetar do ponto atual** (operação mensal): conforme você concilia as parcelas com **✔** na Previsão (elas saem do cronograma para o Previsto × Realizado), um clique re-ancora a simulação na realidade — as parcelas conciliadas saem da projeção (o nº de pagas atualiza sozinho), a base passa a ser a **última parcela realmente paga** (corrigida 1 mês pelo indexador) e o saldo de cada fonte volta a ser o **saldo de hoje** do investimento (ignorando os resgates futuros do plano). Só a simulação muda; os lançamentos efetivados não são tocados. O cabeçalho mostra a data da última reprojeção.
